...
import EditModule from "views/pages/EditModule.js";
...
ReactDOM.render(
  <BrowserRouter>
    <Switch>
      ...
      />
      <Route path="/principal" exact render={props => <Principal {...props} />} />
      <Route
        path="/principal"
        exact
        render={props => <Landing {...props} />}
